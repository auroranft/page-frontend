...
const setActivatingConnector = async (newConnector: any) => {
  ...
  document.getElementById('closeModalConnectAccount').click();
};
</script>

<template>
  <div class="modal fade" id="modalConnectAccount" tabindex="-1" aria-labelledby="modalConnectAccountLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalConnectAccountLabel">Select Wallet</h5>
          <button id="closeModalConnectAccount" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
