        ...
        if (value > 0) {
          for (let index2 = 1; index2 <= value; index2++) {
            ...
            if (item.owner === account.value) {
              ...
              const { data } = await useAsyncData(index2.toString(), () => $fetch(item.tokenURI), "$MDoSRIUboA");
              const tempItem = {
                ...item,
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4dd9a748"]]);

export { index as default };
//# sourceMappingURL=index.775d3aa0.mjs.map
