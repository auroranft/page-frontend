        ...
        if (value > 0) {
          for (let index = 1; index <= value; index++) {
            ...
            if (item.token === collectionAddress && item.onSale) {
              ...
              const { data } = await useAsyncData(index.toString(), () => $fetch(item.tokenURI), "$87SMxQ8pnn");
              const tempItem = {
                ...item,
...
const _token_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-40027c76"]]);

export { _token_ as default };
//# sourceMappingURL=_token_.093d1402.mjs.map
