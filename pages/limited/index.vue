...
function getNftsList() {
  ...
  contract.methods.getSaleNFTList(true, false)
    ...
    <section class="py-5 text-center container">
      <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
          <h1 class="fw-light">Limited NFTs</h1>
          <p class="lead text-muted">Limited</p>
          <p>
            <a href="/account/nfts" class="btn btn-primary my-2">My Nfts</a>
          </p>
        </div>
      </div>
    </section>
